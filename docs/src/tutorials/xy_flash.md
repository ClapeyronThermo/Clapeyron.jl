...
An example of each remaining flash computation will be done with a 1:1 molar mixture of isopentane and isobutane, using the Peng-Robinson equation of state with a consistent Twu alpha (`cPR`):
