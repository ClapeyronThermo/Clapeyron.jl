...
"""
function SAFTgammaEMie(solvents, ions; idealmodel=BasicIdeal, neutralmodel=SAFTgammaMie, ionmodel=GCMSABorn, RSPmodel=Schreckenberg, charge=String[], ideal_userlocations=String[], neutralmodel_userlocations=String[], ionmodel_userlocations=String[], RSPmodel_userlocations=String[], assoc_options=AssocOptions(), reference_state=nothing, verbose=false)
    return ESElectrolyte(solvents, ions; idealmodel, neutralmodel, ionmodel, RSPmodel, charge, ideal_userlocations, neutralmodel_userlocations, ionmodel_userlocations, RSPmodel_userlocations, assoc_options, reference_state, verbose)
end
