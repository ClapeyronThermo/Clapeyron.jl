...
"""
function SAFTVREMie(solvents, ions; idealmodel=BasicIdeal, neutralmodel=SAFTVRMie, ionmodel=MSABorn, RSPmodel=Schreckenberg, charge=String[], ideal_userlocations=String[], neutralmodel_userlocations=String[], ionmodel_userlocations=String[], RSPmodel_userlocations=String[], assoc_options=AssocOptions(), reference_state=nothing, verbose=false)
