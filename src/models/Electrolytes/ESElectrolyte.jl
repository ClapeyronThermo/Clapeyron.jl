...
```julia
model = ESElectrolyte([\"water\"], [\"sodium\", \"chloride\"]; idealmodel=BasicIdeal, neutralmodel=pharmaPCSAFT, ionmodel=DH, RSPmodel=ConstRSP)
```
...
"""
function ESElectrolyte(solvents, ions; idealmodel=BasicIdeal, neutralmodel=pharmaPCSAFT, ionmodel=DH, RSPmodel=ConstRSP, charge=nothing, ideal_userlocations=String[], neutralmodel_userlocations=String[], ionmodel_userlocations=String[], RSPmodel_userlocations=String[], assoc_options=AssocOptions(), verbose=false, reference_state=nothing)
