...
function ∂lnϕ∂P(wrapper::MeanIonicApproach, p, T, z=SA[1.0], cache=∂lnϕ_cache(wrapper, p, T, z, Val{false}()); phase=:unknown, vol0=nothing, threaded=true, vol=volume(wrapper, p, T, z; phase, vol0, threaded))
...
function ∂lnϕ∂T(wrapper::MeanIonicApproach, p, T, z=SA[1.0], cache=∂lnϕ_cache(wrapper, p, T, z, Val{true}()); phase=:unknown, vol0=nothing, threaded=true, vol=volume(wrapper, p, T, z; phase, vol0, threaded))
