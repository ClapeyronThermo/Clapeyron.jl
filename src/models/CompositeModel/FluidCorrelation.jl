...
function FluidCorrelation(_components; gas_volume=nothing, liquid_volume=nothing, saturation=nothing, liquid_cp=nothing, gas_volume_userlocations=String[], liquid_volume_userlocations=String[], saturation_userlocations=String[], liquid_cp_userlocations=String[], verbose=false, liquid_reference_state=:ntp)
    #=Coolprop uses this reference=#
