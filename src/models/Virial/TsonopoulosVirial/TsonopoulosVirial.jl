...
my_idealmodel = MonomerIdeal([\"neon\", \"hydrogen\"]; userlocations=(; Mw=[20.17, 2.0]))
...
model = TsonopoulosVirial([\"neon\", \"hydrogen\"]; userlocations=(; Tc=[44.492, 33.19], Pc=[2679000, 1296400], Mw=[20.17, 2.0], acentricfactor=[-0.03, -0.21]))
```
