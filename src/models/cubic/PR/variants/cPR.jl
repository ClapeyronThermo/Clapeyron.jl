...
"""
function cPR(components; idealmodel=BasicIdeal, alpha=TwuAlpha, mixing=vdW1fRule, activity=nothing, translation=NoTranslation, userlocations=String[], ideal_userlocations=String[], alpha_userlocations=String[], mixing_userlocations=String[], activity_userlocations=String[], translation_userlocations=String[], reference_state=nothing, verbose=false)
    ...
    params = getparams(formatted_components, ["cubic/cPR/cPR_single.csv"]; userlocations=userlocations_cpr, verbose=verbose, ignore_missing_singleparams=["v_shift", "ZRA", "acentricfactor"])
