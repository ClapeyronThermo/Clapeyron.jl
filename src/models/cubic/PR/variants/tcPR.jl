...
"""
function tcPR(components; idealmodel=BasicIdeal, alpha=tcTwuAlpha, mixing=vdW1fRule, activity=nothing, translation=tcTranslation, userlocations=String[], ideal_userlocations=String[], alpha_userlocations=String[], mixing_userlocations=String[], activity_userlocations=String[], translation_userlocations=String[], reference_state=nothing, verbose=false)
    ...
    params = getparams(formatted_components, ["cubic/tcPR/tcPR_single.csv"]; userlocations=tc_userlocations, verbose=verbose, ignore_missing_singleparams=["v_shift", "ZRA", "acentricfactor", "M", "N", "L"])
    ...
    model = CubicModel(PR, params, formatted_components; alpha=_alpha, translation=_translation, idealmodel, mixing, activity, userlocations, ideal_userlocations, alpha_userlocations, activity_userlocations, mixing_userlocations, translation_userlocations, reference_state, verbose)
