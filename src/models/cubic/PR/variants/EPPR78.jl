...
function PPR78Rule(components; activity=nothing, userlocations=String[], group_userlocations=String[], activity_userlocations=String[], verbose::Bool=false)
...
!!! note "Group Fragmentation"
    ...
    Molecule fragmentation into functional groups is available in GCIdentifier.jl, using `EPPR78Groups`
