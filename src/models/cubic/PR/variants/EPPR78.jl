...
abstract type EPPR78Model <: PRModel end

EPPR78_SETUP = ModelOptions(
        :EPPR78;
        supertype=EPPR78Model,
        parent=PR_SETUP,
        members=[
            ModelMember(:alpha, :PR78Alpha),
            ModelMember(:activity, :Nothing),
            ModelMember(:mixing, :PPR78Rule; groupcontribution_allowed=true),
...
createmodel(EPPR78_SETUP; verbose=true)
export EPPR78
