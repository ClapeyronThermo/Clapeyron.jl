...
```
"""
function EmpiricPseudoPure(components::Union{AbstractString,AbstractVector{<:AbstractString}}; userlocations=String[], ancillaries=nothing, ancillaries_userlocations=String[], estimate_pure=false, coolprop_userlocations=true, Rgas=nothing, verbose=false, idealmodel=nothing, ideal_userlocations=String[])
