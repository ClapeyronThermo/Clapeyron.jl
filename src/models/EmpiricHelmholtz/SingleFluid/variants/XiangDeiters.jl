function XiangDeitersConsts(ω, θ)
    ...
    l = [1, 1, 1, 1, 2, 2, 2, 3]
    a0 = [8.5740489E-01, -3.2863233E+00, 1.6480939E+00, -5.4524817E-02, 6.1623592E-02, 2.7389266E-04, -6.0655087E-02, -3.1811852E-02, -1.1550422E-01, -1.8610466E-02, -1.8348671E-01, 5.5071325E-03, -1.2268039E-02, -5.0433436E-03]
    a1 = [5.6200117E-01, 3.2439544E+00, -4.9628768E+00, -2.2132851E-01, 9.3388356E-02, 2.4940171E-05, -1.7519204E-01, 8.9325660E-01, 2.9886613E+00, 1.0881387E-01, -6.7166746E-01, 1.4477326E-01, -2.8716809E-01, -1.1478402E-01]
    a2 = [-8.1680511E+01, 4.6384732E+02, -2.7970850E+02, 2.9317364E+01, -2.2324825E+01, -5.0932691E-02, -7.2836590E+00, -2.2063100E+02, -3.0435126E+02, 5.8514719E+00, 1.7995451E+02, -1.0178400E+02, 4.0848053E+01, 1.2411984E+01]
    n = a0 .+ a1 .* ω + a2 .* θ
...
model = XiangDeiters([\"hydrogen\"]; userlocations=(; Tc=[44.492], Pc=[2679000], Vc=[4.25e-5], Mw=[2.0], acentricfactor=[-0.21]))
```
...
"""
function XiangDeiters(component; idealmodel=BasicIdeal, userlocations=String[], ideal_userlocations=String[], Rgas=nothing, verbose=false)
    components = format_components(component)
