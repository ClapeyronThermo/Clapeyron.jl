function TholLJ()
    ...
    n = [0.005208073, 2.186252, -2.161016, 1.4527, -2.041792, 0.18695286, -0.090988445, -0.4974561, 0.10901431, -0.80055922, -0.568839, -0.6208625, -1.4667177, 1.891469, -0.1383701, -0.3869645, 0.1265702, 0.605781, 1.179189, -0.47732679, -9.9218575, -0.5747932, 0.003772923]
    ...
    anc_liquid_fn = GenericAncEvaluator([0.1362e+1, 0.2093e+1, -0.2110e+1, 0.3290e0, 0.1410e+1], [0.313, 0.940, 1.630, 17.0, 2.4], T_c, rho_c, :noexp, false)
    anc_ps_fn = GenericAncEvaluator([0.54000e+1, 0.44704e01, -0.18530e+1, 0.19890e0, -0.11250e+1], [1.0, 1.5, 4.7, 2.5, 21.4], T_c, P_c, :exp, true)
