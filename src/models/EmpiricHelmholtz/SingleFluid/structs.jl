...
struct SingleFluidProperties <: EoSParam
    ...
    function SingleFluidProperties(Mw, Tr, rhor, lb_volume, Tc=NaN, Pc=NaN, rhoc=NaN, Ttp=NaN, ptp=NaN, rhov_tp=NaN, rhol_tp=NaN, acentric_factor=NaN, Rgas=R̄, pseudo_pure=false)
