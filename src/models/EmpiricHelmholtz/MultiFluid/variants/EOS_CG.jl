...
function EOS_CG(components; verbose=false, Rgas=R̄)
    return MultiFluid(components; mixing=AsymmetricMixing, departure=EmpiricDeparture, pure_userlocations=String["@REMOVEDEFAULTS", "@DB/Empiric/EOS_CG/pures"], mixing_userlocations=String["@REMOVEDEFAULTS", "@DB/Empiric/EOS_CG/mixing/EOS_CG_mixing_unlike.csv"], departure_userlocations=String["@REMOVEDEFAULTS", "@DB/Empiric/EOS_CG/departure/EOS_CG_departure_unlike.csv"], coolprop_userlocations=false, Rgas=Rgas, verbose=verbose)
end
export EOS_CG
