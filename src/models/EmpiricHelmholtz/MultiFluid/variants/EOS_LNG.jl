...
"""
function EOS_LNG(components; Rgas=8.314472, reference_state=nothing, verbose=false)
    return MultiFluid(components; mixing=AsymmetricMixing, departure=EmpiricDeparture, pure_userlocations=String["@REMOVEDEFAULTS", "@DB/Empiric/GERG2008/pures"], mixing_userlocations=String["@REMOVEDEFAULTS", "@DB/Empiric/EOS_LNG/mixing/EOS_LNG_mixing_unlike.csv"], departure_userlocations=String["@REMOVEDEFAULTS", "@DB/Empiric/EOS_LNG/departure/EOS_LNG_departure_unlike.csv"], coolprop_userlocations=false, Rgas=Rgas, reference_state=reference_state, verbose=verbose)
end
export EOS_LNG
