...
function ChemPotMeltingPressure(; v0=nothing, check_triple=false, f_limit=0.0, atol=1e-8, rtol=1e-12, max_iters=10000)
...
function ChemPotMeltingTemperature(; v0=nothing, T0=nothing, check_triple=false, f_limit=0.0, atol=1e-8, rtol=1e-12, max_iters=10000)
...
function IsoGibbsMeltingPressure(; p0=nothing, check_triple=false, f_limit=0.0, atol=1e-8, rtol=1e-12, max_iters=10000)
...
function IsoGibbsMeltingTemperature(; T0=nothing, check_triple=false, f_limit=0.0, atol=1e-8, rtol=1e-12, max_iters=10000)
