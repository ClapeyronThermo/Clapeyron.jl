...
"""
function spinodal_pressure(model::EoSModel, T, z=SA[1.0]; v0=nothing, phase=:unknown)
...
"""
function spinodal_temperature(model::EoSModel, p, z=SA[1.0]; T0=nothing, v0=nothing, phase=:unknown)
    check_arraysize(model, z)
