...
function FugDewPressure(; vol0=nothing, p0=nothing, x0=nothing, noncondensables=nothing, f_limit=0.0, atol=1e-8, rtol=1e-12, max_iters=10^4, itmax_newton=10, itmax_ss=5, tol_x=1e-8, tol_p=1e-8, tol_of=1e-8, second_order=true)
...
function dew_pressure_impl(model::EoSModel, T, y, method::FugDewPressure)
    ...
    data = FugData(FugEnum.DEW_PRESSURE, method.itmax_ss, method.itmax_newton, method.tol_p, method.tol_x, method.tol_of, method.second_order, false)
...
function FugDewTemperature(; vol0=nothing, T0=nothing, x0=nothing, noncondensables=nothing, f_limit=0.0, atol=1e-8, rtol=1e-12, max_iters=10^4, itmax_newton=10, itmax_ss=5, tol_x=1e-8, tol_T=1e-8, tol_of=1e-8, second_order=true)
...
function dew_temperature_impl(model::EoSModel, p, y, method::FugDewTemperature)
    ...
    data = FugData(FugEnum.DEW_TEMPERATURE, method.itmax_ss, method.itmax_newton, method.tol_T, method.tol_x, method.tol_of, method.second_order, false)
