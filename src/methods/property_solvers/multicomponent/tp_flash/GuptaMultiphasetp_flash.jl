using Debugger
# Original code from Angel Martin, University of Valladolid (Spain), distributed as part of the "ECE" Matlab thermodynamics package
# This file is under the GNU General Public License see <http://www.gnu.org/licenses/>.

# model = EPPR78(["carbon dioxide", "nitrogen"]); p = 9.9905e6; T = 218.157; z = [0.5, 0.5]
# tp_flash(model, p, T, z, GuptaMultiphaseFlash())
