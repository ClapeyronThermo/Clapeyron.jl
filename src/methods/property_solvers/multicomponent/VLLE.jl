...
function VLLE_pressure(model::EoSModel, T; v0=nothing)
    ...
    f! = (F, z) -> @inbounds Obj_VLLE_pressure(model, F, T, z[1], z[2], z[3], z[idx_x], z[idx_xx], z[idx_y])
...
function VLLE_temperature(model::EoSModel, p; v0=nothing)
    ...
    f! = (F, z) -> @inbounds Obj_VLLE_temperature(model, F, p, z[1], z[2], z[3], z[4], z[idx_x], z[idx_xx], z[idx_y])
