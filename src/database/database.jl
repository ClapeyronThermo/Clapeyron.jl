...
"""
function getparams(components, locations=String[]; userlocations=String[], asymmetricparams=String[], ignore_missing_singleparams=String[], ignore_headers=IGNORE_HEADERS, verbose::Bool=false, species_columnreference="species", source_columnreference="source", site_columnreference="site", normalisecomponents::Bool=true, return_sites::Bool=true, component_delimiter="~|~")
    ...
    options = ParamOptions(; userlocations, asymmetricparams, ignore_missing_singleparams, ignore_headers, verbose, species_columnreference, source_columnreference, site_columnreference, normalisecomponents, return_sites, component_delimiter)
...
function buildsites(components, allparams, allnotfoundparams, options)
    ...
    n_sites_columns = isempty(options.n_sites_columns) ? Dict{String,String}(vi => string("n_", vi) for vi in v) : options.n_sites_columns
...
@nospecialize
function createparams(components, filepaths, options::ParamOptions=DefaultOptions, parsegroups=:off)
...
function findparamsinnt(components, options::ParamOptions, parsegroups=:off, csv_file_options=NT_CSV_OPTIONS) #default options
