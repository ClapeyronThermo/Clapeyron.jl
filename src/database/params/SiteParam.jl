...
```julia-repl
julia> model3 = SAFTgammaMie([\"ethanol\", (\"nonadecanol\", [\"CH3\"=>1, \"CH2\"=>18, \"OH\"=>1]), (\"ibuprofen\", [\"CH3\"=>3, \"COOH\"=>1, \"aCCH\"=>1, \"aCCH2\"=>1, \"aCH\"=>4])])
...
function SiteParam(components, sites, n_sites, sourcecsvs=String[], site_translator=nothing)
    ...
    param = SiteParam(components, sites, _n_sites, Vector{Vector{Int}}(undef, 0), String[], Vector{Vector{Int}}(undef, 0), Vector{Vector{Int}}(undef, 0), sourcecsvs, site_translator)
