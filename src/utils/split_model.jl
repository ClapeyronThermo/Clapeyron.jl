...
function each_split_model(param::SingleParameter, I)
    return SingleParameter(param.name, param.components[I], each_split_model(param.values, I), param.ismissingvalues[I], param.sourcecsvs, param.sources)
end
...
function each_split_model(param::PairParameter, I)
    ...
    res = PairParameter(param.name, components, value, ismissingvalues, param.sourcecsvs, param.sources)
    return res
end
...
function each_split_model(param::AssocParam, I)
    ...
    return AssocParam(param.name, param.components[I], _value, sites_i, param.sourcecsvs, param.sources)
end
...
function each_split_model(param::SiteParam, I)
    return SiteParam(param.components[I], param.sites[I], each_split_model(param.n_sites, I), param.i_sites[I], param.flattenedsites, param.n_flattenedsites[I], param.i_flattenedsites[I], param.sourcecsvs, __split_site_translator(param.site_translator, I))
end
