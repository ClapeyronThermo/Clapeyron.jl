...
const J = JutulDarcy
function J.MultiPhaseCompositionalSystemLV(equation_of_state::C.EoSModel, phases=(J.LiquidPhase(), J.VaporPhase()); reference_densities=ones(length(phases)), other_name="Water", reference_phase_index=J.get_reference_phase_index(phases))
