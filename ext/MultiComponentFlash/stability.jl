...
function M.stability_2ph!(storage, K, eos::C.EoSModel, c; verbose::Bool=false, extra_out::Bool=false, check_vapor::Bool=true, check_liquid::Bool=true, kwarg...)
    ...
    report = M.StabilityReport(stable_liquid=stable_liquid, trivial_liquid=trivial_vapor, stable_vapor=stable_vapor, trivial_vapor=trivial_vapor)
