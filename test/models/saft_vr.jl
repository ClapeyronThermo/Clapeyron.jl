...
@testset verbose = true "SAFT-VR-Mie Models" begin
    @printline
...
@testset verbose = true "SAFT-γ-Mie Models" begin
    @printline
    let T = 298.15, V = 1e-4, z1 = Clapeyron.SA[1.0], z = [0.5, 0.5], z3 = [0.333, 0.333, 0.333]
        ...
        @testset "structSAFTgammaMie" begin
            species = [("ethanol", ["CH3"=>1, "CH2OH"=>1], [("CH3", "CH2OH")=>1]), ("octane", ["CH3"=>2, "CH2"=>6], [("CH3", "CH2")=>2, ("CH2", "CH2")=>5])]
        ...
        @testset verbose = true "SAFTgammaMie - issues" begin
            @testset "DM1" begin
                ...
                model_mix = SAFTgammaMie(
                    ...
                    userlocations=(
                        ...
                        n_a1=[0, 1],
                        n_a2=[0, 1],
                        epsilon_assoc=Dict([(("NH2", "H"), ("NH2", "e")) => 1070.80, (("CO2", "a1"), ("NH2", "e")) => 3313, (("CO2", "a2"), ("NH2", "e")) => 4943.6]),
                        bondvol=Dict([(("NH2", "H"), ("NH2", "e")) => 95.225e-30, (("CO2", "a1"), ("NH2", "e")) => 3280.3e-30, (("CO2", "a2"), ("NH2", "e")) => 142.64e-30]),
                    ),
                )
