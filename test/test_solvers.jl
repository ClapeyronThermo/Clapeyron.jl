...
@testset "Solvers Module" begin
    ...
    @testset "roots3" begin
        ...
        @test @inferred(SOL.roots3([1.0, -3.0, 3.0, -1.0])) ≈ [1, 1, 1]
        p1 = (0.4179831841886642, -16.86256511617483, 1.6508521434627874, 1.0)
        p2 = (0.7336510424849684, -17.464843881306653, 1.6925644348171853, 1.0)
        p3 = (-1, 3, -3, 1)
        p4 = (1, -1, -1, 1)
        s1 = (3, -5.0238891763914015, 0.024849000208331546, 3.3481880327202824)
        s2 = (3, -5.126952070514365, 0.04218405979418538, 3.392203575902995)
        s3 = (1, 1.0, 1.0, 1.0)
        s4 = (2, -1.0, 1.0, 1.0)
