...
"""
function tpflash_optimize(objective::Function; backend::Symbol, population_size::Int, fe_max::Int, lb::Vector{Float64}, ub::Vector{Float64}, seed::Int, time_limit::Float64, stagnation_evals::Int, stagnation_tol::Float64, verbose::Bool=false)
    if backend == :sass
